...
export function ChangePasswordModal({ isOpen, onClose, isRequired = false }: ChangePasswordModalProps) {
  ...
  // Get current password hint for admin
          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                {user?.role === "admin" && <p className="text-xs text-gray-500">Hint: {getCurrentPasswordHint()}</p>}
              </div>
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className={`flex-1 ${isRequired ? "bg-orange-600 hover:bg-orange-700" : "bg-blue-600 hover:bg-blue-700"}`}
                >
                  {isLoading ? (
                    <>
            ...
            {user?.role === "admin" && (
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <h4 className="text-sm font-medium text-blue-800 mb-2">Info Admin RW {user.rw}:</h4>
